...
class TestLaTeXRenderer:
    ...
    def test_chord_positioning(self):
        ...
        song = Song(properties=Properties(titles=["Test"]), verses=[verse])
    ...
    def test_line_without_chords(self):
        ...
        verse = Verse(
            name="c", verse_type=VerseType.CHORUS, lines=[Line(text="No chords here", chords=[])]
        )
    ...
    def test_multiple_verses(self):
        ...
        song = Song(properties=Properties(titles=["Test"]), verses=verses)
    ...
    def test_render_songfile_with_section(self, sample_song):
        ...
        output = renderer.render_songfile(
            sections=sections, song_content=song_content, use_column_switching=True
        )
    ...
    def test_songfile_column_switching(self, sample_song):
        ...
        sections = {"Section 1": [sample_song], "Section 2": [sample_song]}
        song_content = {sample_song.source_file: renderer.render_song(sample_song)}
    ...
    def test_songfile_without_column_switching(self, sample_song):
        ...
        output = renderer.render_songfile(
            sections=sections, song_content=song_content, use_column_switching=False
        )
    ...
    def test_empty_verse_handling(self):
        ...
        verse = Verse(name="v1", verse_type=VerseType.VERSE, lines=[])  # Empty verse
